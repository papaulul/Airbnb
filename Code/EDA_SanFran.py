...
#Read in dataset 
df = pd.read_csv('SanFranListing_With_Plus.csv',index_col = 0)
...
# To CSV
# population_final_columns.to_csv('Cleaner_Airbnb_Listings.csv')
