...
df.set_value(631, 'zipcode', 90404)
...
df_model = df.drop(['host_id','host_name','host_since','host_verifications','neighbourhood_cleansed','city','state','zipcode','market','smart_location','id','Unnamed: 61','translation missing: en.hosting_amenity_49','translation missing: en.hosting_amenity_50','Toilet paper','listing_count_LA','number_of_amenities','weekly_price'], axis=1)
# In[18]:
